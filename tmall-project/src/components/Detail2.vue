  ...
  <div class="page">
    <div class="top-box">
      ...
      <template v-else>
        <div class="content">
          ...
          <div class="back-warp2" style="padding-bottom: 10px;padding-top: 10px;" @click="shopfun">
            <img src="../images/product/4.png" alt="图片加载失败" class="title-image" />
          </div>
        </div>
      </template>
    </div>
    ...
    <div class="middle-box" @scroll="divScroll" v-for="item in list" :key="item.name">
      ...
      <div class="box9" style="margin-top: 10px;">
        <img src="../images/product/back2/b1.jpg" alt style="height: 456px; width: 100%;" />
        <img src="../images/product/back2/b2.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b3.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b4.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b5.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b6.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b7.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b8.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b9.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b10.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b11.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b12.jpg" alt style="height: 456px;width: 100%;" />
        <img src="../images/product/back2/b13.jpg" alt style="height: 325px;width: 100%;" />
        <img src="../images/product/back2/b14.png" alt style="height: 184px;width: 100%;" />
      </div>
      ...
      <div class="box10" style="margin-top: 10px;height: 50px;"></div>
        ...
        <div class="bottom-box">
          ...
          <div class="bottom2"  @click="addFun1()">
            <span>加入购物车</span>
          </div>
          <div class="bottom3">
            <span>立即购买</span>
...
export default {
  ...
  data() {
   ...
   created(){
     let url = `http://127.0.0.1:5500/data/detail.json`;
    let that = this;
