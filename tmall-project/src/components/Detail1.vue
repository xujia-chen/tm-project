  ...
  <div class="page">
    <div class="top-box">
      <template v-if="seen">
        ...
        <div class="back-warp2">
          <div class="item" style="padding-left: 3px;padding-top: 3px;"  @click="shopfun">
            <img src="../images/product/3.png" alt="图片加载失败" class="title-image"  />
          </div>
        </div>
      </template>
      <template v-else>
    ...
    <div class="middle-box" @scroll="divScroll" v-for="item in list" :key="item.name">
      ...
      <div class="box9" style="margin-top: 10px;">
        <img src="../images/product/back1/back1.jpg" alt style="height: 580px; width: 100%;" />
        <img src="../images/product/back1/back2.jpg" alt style="height: 3px;width: 100%;" />
        <img src="../images/product/back1/back3.jpg" alt style="height: 580px;width: 100%;" />
        <img src="../images/product/back1/back4.jpg" alt style="height: 132px;width: 100%;" />
        <img src="../images/product/back1/back5.jpg" alt style="height: 580px;width: 100%;" />
        <img src="../images/product/back1/back6.jpg" alt style="height: 158px;width: 100%;" />
        <img src="../images/product/back1/back7.jpg" alt style="height: 408px;width: 100%;" />
        <img src="../images/product/back1/back8.png" alt style="height: 184px;width: 100%;" />
      </div>
    ...
    <div class="bottom-box">
      ...
      <div class="bottom2" @click="addFun()">
        <span>加入购物车</span>
      </div>
      <div class="bottom3">
        <span>立即购买</span>
